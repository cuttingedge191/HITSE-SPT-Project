...
INSERT INTO `goods_info` VALUES (1000000000000,'权限',9.99,100,66.66,'系统最高权限'),(1234567890123,'测试商品',4.33,10,7.2,'测试'),(6666666666666,'实践者的研究方法',20,35,20,'教材'),(6947503737252,'晨光0.5mm黑色签字笔',0.8,3,1.5,'笔'),(6953787312399,'A4资料册',1.49,5,3.4,'20页'),(9787121401367,'计算机网络考研复习指导',25,60,34.99,'2022年版'),(9876543210123,'软件V3.0',19.99,66,30,'软件过程与工具');
